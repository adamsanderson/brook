...
In order to publish Brook, you must package the extension a zip file:

```
yarn package
```

Upload the versioned zip file from the `dist` directory to 
[mozilla](https://addons.mozilla.org/en-US/developers/addon/brook-feed-reader/versions/submit/)
and
